...
const routes: Routes = [
  ...
  },
  {
    path: 'property-type',
    loadChildren: () =>
      import('../../property-type/property-type.module').then(
        (m) => m.PropertyTypeModule
      ),
    canActivate: [AuthGuard],
  },
  {
    ...
    loadChildren: () =>
      import('../../property-categories/property-category.module').then(
        (m) => m.PropertyCategoryModule
      ),
    canActivate: [AuthGuard],
  },

  {
    ...
    loadChildren: () =>
      import('../../additional-information/additional-information.module').then(
  ...
  },
  {
    ...
    loadChildren: () =>
      import('../../furnishing-type/furnishing-type.module').then(
        (m) => m.FurnishingTypeModule
      ),
    canActivate: [AuthGuard],
  },
  {
  ...
  },
  {
    path: 'specality',
    loadChildren: () =>
      import('../../specality/specality.module').then((m) => m.SpecalityModule),
    canActivate: [AuthGuard],
  },
  {
    path: 'tag',
